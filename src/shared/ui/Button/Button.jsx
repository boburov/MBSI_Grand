...
const VARIANTS = {
  primary:
    'bg-primary text-white shadow-card hover:enabled:bg-primary-hover',
  outline:
...
export function Button({
  ...
  // <button> uchun type kerak; a/Link kabi elementlarda type bermaymiz
  const extraProps = Component === 'button' ? { type } : {}
